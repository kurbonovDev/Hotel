...
class GetApartmentsHistoryRepositoryImp @Inject constructor(private val api:HomeAPI): GetApartmentsHistoryRepository {
    override suspend fun getApartmentsHistory(token:String): Response<HistoryResponse> {
