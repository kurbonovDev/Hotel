...
import com.example.hotel.domain.repository.BookApartmentsRepository
...
class BookApartmentsRepositoryImp @Inject constructor(private val api:HomeAPI):
    BookApartmentsRepository {
    override suspend fun bookApartment(token:String,bookingRequest: BookingRequest): Response<BookingResponse> {
        return api.bookApartment(token,bookingRequest)
    }
